...
func main() {
	...
	generateDefsecComplianceSpecPages("../avd-repo/trivy-policies-repo/specs/compliance", "../avd-repo/content/compliance")
	...
	generateDefsecPages("../cmd/trivy-policies-generator/avd_docs", "../avd-repo/content/misconfig")
